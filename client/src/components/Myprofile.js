...
function MyProfile() {
  ...
  async function changeUserDetails(name, email) {
    ...
    try {
      const res = (
        await axios.patch("/api/users/edituser", { _id, name, email })
      ).data;
  ...
  async function changePassword(currentPassword, newPassword, confirmPassword) {
    ...
    try {
      const res = (
        await axios.patch("/api/users/changepassword", {
          _id,
          currentPassword,
          newPassword,
        })
          ...
          <div className="button-container">
            ...
            >
              <Form
                ...
                name="control-ref"
                onFinish={(values) =>
                  changeUserDetails(values.Name, values.Email)
                }
                size="large"
